...
public abstract class Creature {
    ...
    public void step()
    {
        //for each creature the stepLen and the direction will vary but for all of them it follows the general guideline
        this.point.x += (this.stepLen * dirX[this.dir]) % 80;
        this.point.y += (this.stepLen * dirY[this.dir]) % 80;
        //if the grid point is less than zero, add 80 (which is city's width)
        //if the grid point is more than 80, then make it 1 so it goes back
    }
